...
// The symbol chooser dialog is in draw_symbols_gui.c.  What is left here is
// rendering: symbols, trails, wind barbs, dead-reckoning, text.  It needs no
// fontlist and no dialog.
